...
<head>
	<meta charset="utf-8">
		<title><?php echo $description ?> - Thay Đổi Số Điện Thoại</title>
...
<?php } 
 ...
 <div class="d-grid my-2">
            ...
            <h2 class="page-title">Thay Đổi Số Điện Thoại</h2>
 <form method="post" name="register" action="" id="register">
			<input id="action" type="hidden" value="dangky" name="action">               
		<div class="mb-3"> <input name="phone" class="form-control" type="text" placeholder="Số Điện Thoại" required="" value="" maxlength="10">            </div>
	    <div class="mb-3"> <input name="password2" class="form-control" type="password" placeholder="Mật Khẩu Cấp 2" required="" value="">          </div>   
        <div class="mb-3">       
	   <div class="mb-3">
