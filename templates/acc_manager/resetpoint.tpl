...
<head>
	<meta charset="utf-8">
		<title><?php echo $description ?> - Reset HP/MP</title>
...
<?php } 
 ...
 <div class="d-grid my-2">
            ...
            <h2 class="page-title">Reset HP/MP</h2>
 <form method="post" name="register" action="" id="register">
			<input id="action" type="hidden" value="dangky" name="action">  
   <label for="captcha" class="form-label">
            Chọn Nhân Vật<span class="required-mark">*</span>
        </label>			
		<select id="nhanvat" name="nhanvat" class="form-control">
 ...
 <label for="captcha" class="form-label">
            Chọn Thanh Toán<span class="required-mark">*</span>
        </label>			
		<select id="paypal" name="paypal" class="form-control">
                            <option value="">[Chọn Thanh Toán]</option>
                               <option value="Gold">Giá <?php echo number_format($gold, 0, ',', '.');?> Vàng</option>
                   <option value="Silk">Giá <?php echo number_format($silk, 0, ',', '.');?> Silk</option>
                                                    </select>  													
	   <div class="mb-3">
