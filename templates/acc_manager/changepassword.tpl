...
<head>
	<meta charset="utf-8">
		<title><?php echo $description ?> - Thay Đổi Mật Khẩu</title>
...
<?php } 
 ...
 <form method="post" name="register" action="" id="register">
			...
			<div class="mb-3">
                    <input name="currentpassword" class="form-control" type="password" placeholder="Mật Khẩu Cũ" required="" value="">            </div>
        <div class="mb-3">
                    <input name="passwordnew" class="form-control" type="password" placeholder="Mật Khẩu Mới" required="" value="">            </div>
        <div class="mb-3">
           <input name="repasswordnew" class="form-control" type="password" placeholder="Nhập Lại Mật Khẩu Mới" required="" value="">            </div>
	<div class="mb-3">
                    <input name="password2" class="form-control" type="password" placeholder="Mật Khẩu Cấp 2" required="" value="">            </div>
        <div class="mb-3">       
	   <div class="mb-3">
