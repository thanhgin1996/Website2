...
<head>
	<meta charset="utf-8">
		<title><?php echo $description ?> - Thay Đổi Mật Khẩu 2</title>
...
<?php } 
 ...
 <div class="d-grid my-2">
            ...
            <h2 class="page-title">Đổi Mật Khẩu Cấp 2</h2>
 <form method="post" name="register" action="" id="register">
			<input id="action" type="hidden" value="dangky" name="action">               
		<div class="mb-3"> <input name="passwordold2" class="form-control" type="password" placeholder="Mật Khẩu Cấp 2 Cũ" required="" value="">            </div>
	    <div class="mb-3"> <input name="passwordnew2" class="form-control" type="password" placeholder="Mật Khẩu Cấp 2 Mới" required="" value="">          </div>
	    <div class="mb-3"> <input name="repasswordnew2" class="form-control" type="password" placeholder="Nhập Lại Mật Khẩu Cấp 2 Mới" required="" value="">          </div>     
        <div class="mb-3">       
	   <div class="mb-3">
      ...
      <button class="btn btn-primary" type="submit" name="SubmitCP" value="">Thay Đổi</button> 
</form>
        </div>
     </div>
					<?php 
