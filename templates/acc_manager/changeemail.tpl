...
<head>
	<meta charset="utf-8">
		<title><?php echo $description ?> - Thay Đổi Email</title>
...
<?php } 
 ...
 <div class="d-grid my-2">
            ...
            <h2 class="page-title">Thay Đổi Email</h2>
 <form method="post" name="register" action="" id="register">
			<input id="action" type="hidden" value="dangky" name="action">               
		<div class="mb-3"> <input name="email" class="form-control" type="email" placeholder="Email Mới" required="" value="">            </div>
